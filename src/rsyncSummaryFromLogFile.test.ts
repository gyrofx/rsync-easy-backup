    ...
    expect(
    ...
    ).toMatchInlineSnapshot(`
      {
        ...
        "disk": {
          ...
          "totalSizeInBytes": "263174212",
          "usedInBytes": "96951088",
          "uuid": "3255683f-53a2-4fdf-91cf-b4c10S41e2a62",
        },
        "files": [
          "src/server.ts",
          "src/serverWithRedis.ts",
          "src/worker.ts",
          "src/workerWithRedis.ts",
          "src/db/updateVideoStatusInDB.ts",
          "src/opts/opts.ts",
          "src/queue/defaultJobOptions.ts",
          "src/queue/initQueues.ts",
          "src/redisQueue/initWorker.ts",
          "src/redisQueue/listenQueue.ts",
          "src/redisQueue/listenQueueBlocked.ts",
          "src/redisQueue/processRecordingQueue.ts",
          "src/redisQueue/pushRecordingJob.ts",
          "src/redisQueue/redis.ts",
          "src/server/Video.ts",
          "src/server/initWorker.ts",
          "src/server/processFailedQueue.ts",
          "src/server/processFinishedQueue.ts",
          "src/server/pushRecordingJob.ts",
          "src/server/queueNames.ts",
          "src/server/server.ts",
          "src/utils/sleep.ts",
          "src/worker/initWorker.ts",
          "src/worker/processRecordingQueue.ts",
        ],
        "name": "name",
        "numberOfFiles": 21206,
